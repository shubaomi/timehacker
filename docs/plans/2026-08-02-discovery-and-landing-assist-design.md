...
- before 9.50 seconds, the existing effect curve remains unchanged;
- from 9.50, the displayed tenth advances once per real second;
- 9.50, 9.60, 9.70, 9.80, and 9.90 each remain visible for one second;
- 10.00 remains visible for three seconds total: its normal one-second step plus two extra seconds;
- after 10.00, time leaves continuously at the same average rate of 0.10 displayed seconds per real second, so overshoot remains legible and millisecond tolerance assists retain their authored judgment semantics.
...
- Every generated cheat reaches a 9.50 landing zone and exposes an exact 10.00 plateau of at least three seconds.
- Client and server timing mappings agree at 9.50, 10.00, and after the plateau.
